...
@section('content')
    ...
    <div class="p-4 sm:ml-64">
        ...
        <div class="flex flex-wrap justify-center">
            <form class="flex flex-col w-full md:w-1/2 mx-4 space-y-4 max-w-full" action="/add-album" method="post" enctype="multipart/form-data">
                @csrf
