   ...
   <div class="p-4 sm:ml-64">
      <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
          ...
          <div class="flex gap-1 border-2 justify-start border-gray-50 overflow-x-auto overflow-y-hidden p-2">
            ...
            <div class="flex w-full gap-2 p-1 mx-auto my-2 rounded-lg dark:bg-gray-600">
                <button type="button" data-kategori-id="{{ $kategoris->id }}" class="border-2 px-5 py-1.5 bg-gray-200 text-xs font-medium text-gray-900 hover:bg-gray-200 dark:text-white dark:hover:bg-gray-700 rounded-lg">
                    {{ $kategoris->nama }}
                </button>
            </div>
            @endforeach
...
//         $('.rounded-lg button').on('click', function() {
//             var kategoriId = $(this).data('kategori-id');
//             console.log(kategoriId);
//             // Kirim permintaan Ajax ke server berdasarkan ID kategori
//             $.ajax({
//                 url: '/data-berdasarkan-kategori/' + kategoriId,
//                 method: 'GET',
//                 success: function(response) {
//                     // Tampilkan hasil data berdasarkan kategori
//                     dataExplore = response.data.data; // Mengganti dataExplore dengan data baru dari server
//                     console.log(dataExplore);
//                     $('#exploreData').empty();

//                         getExplore(dataExplore); // Mengirim dataExplore sebagai parameter
